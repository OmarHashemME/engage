...
const MaterialsPage: React.FC = () => {
  return (
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg animate-fade-in">
      <h1 className="text-3xl font-bold text-gray-900 mb-4">Materials & Resources</h1>
      <div className="text-center py-12 px-6 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
        ...
        <p className="mt-2 text-gray-500">
          This section will contain downloadable materials, links, and other resources for the course.
        </p>
      </div>
    </div>
  );
